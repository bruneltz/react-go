    ...
    return (
        <div className="mx-auto  max-w-[640px] flex gap-6 py-10 px-4 flex-col">
            <div className="flex gap-3 px-3 items-center">
                ...
                <span className="text-zinc-500 text-sm truncate"> Código da sala: <span className="text-zinc-300">{roomId}</span></span>
                ...
                <button
                    ...
                    type="submit">Compartilhar <Share2 className="size-3" /></button>
            </div>
